...
module alloy_tests/js_tests/memory_module_js_test_R_polp_pola
...
one sig ExecJS_Test_R_polp_pola extends ExecJS {} {

  ev_b in Unord

  (ev_a + ev_c + ev_d) in SC
...
pred test[] {
  some ExecJS_Test_R_polp_pola

  consistent[ExecJS_Test_R_polp_pola]
}
